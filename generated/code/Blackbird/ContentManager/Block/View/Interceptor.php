...
/**
 * Interceptor class for @see \Blackbird\ContentManager\Block\View
 */
class Interceptor extends \Blackbird\ContentManager\Block\View implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Blackbird\ContentManager\Model\ResourceModel\Content\CollectionFactory $contentCollectionFactory, \Blackbird\ContentManager\Model\Config\Source\ContentType\Layouts $sourceLayouts, \Magento\Cms\Model\Template\FilterProvider $filterProvider, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $contentCollectionFactory, $sourceLayouts, $filterProvider, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProcessedData');
        if (!$pluginInfo) {
            return parent::getProcessedData($value);
        } else {
            return $this->___callPlugins('getProcessedData', func_get_args(), $pluginInfo);
        }
    }
